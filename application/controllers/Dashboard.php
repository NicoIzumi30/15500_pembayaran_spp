...
SET column1 = value1, column2 = value2, ... 'INSERT INTO spp VALUES (null,2025,300000)'-- WHERE condition; ";
	...
	public function cetak_laporan()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$awal = htmlspecialchars($this->input->post('awal'));
			$akhir = htmlspecialchars($this->input->post('akhir'));
			$data['pembayaran'] = $this->M_dashboard->cetak_laporan($awal, $akhir);
			$this->load->view('dashboard/cetak_laporan.php', $data);
		}
	}
